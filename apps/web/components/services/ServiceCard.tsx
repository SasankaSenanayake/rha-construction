...
export function ServiceCard({ service }: { service: LocalizedService }) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden bg-ink-950 transition-all duration-300 hover:-translate-y-1 hover:shadow-soft-lg"
    >
      <div className="notch-panel relative aspect-[4/3] overflow-hidden bg-ink-800 [--notch:28px]">
        ...
        <span className="absolute left-5 top-5 flex h-11 w-11 items-center justify-center border border-white/40 text-white backdrop-blur-sm transition-colors duration-300 group-hover:border-white group-hover:bg-white group-hover:text-ink-950">
