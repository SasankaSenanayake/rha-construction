    ...
    <>
      <section className="blueprint-grid bg-ink-900 py-20 text-white">
        <div className="container-page">
          <Reveal>
            <h1 className="font-serif text-4xl font-semibold md:text-5xl">{t("title")}</h1>
      ...
      <Section>
        <div className="grid gap-12 md:grid-cols-2">
          <Reveal>
            <h2 className="font-serif text-2xl font-semibold text-ink-900">{t("historyTitle")}</h2>
            <p className="mt-4 leading-relaxed text-sand-600">{t("historyBody")}</p>
          </Reveal>
          <Reveal delay={100}>
            <h2 className="font-serif text-2xl font-semibold text-ink-900">{t("missionTitle")}</h2>
      ...
      <Section tone="muted">
        <Reveal>
          <h2 className="text-center font-serif text-3xl font-semibold text-ink-900 md:text-4xl">{t("whyChooseUsTitle")}</h2>
        </Reveal>
